...
export const errorMessages = {
  ...
  [AuthErrorCodes.WEAK_PASSWORD]: 'Password must be at least 6 characters long and include at least one uppercase letter, one lowercase letter, and one number.',
