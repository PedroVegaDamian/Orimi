...
const NewAddressModal: React.FC<NewAddressModalProps> = ({
	...
	const [newAddress, setNewAddress] =
		useState<Partial<Address>>(initialAddressState)
	...
	return (
		<ModalBase isOpen={isOpen} close={close}>
			...
			<form
				...
				className="bg-white_color p-4 rounded-lg max-h-full overflow-auto"
			>
				<div className="flex flex-row flex-wrap items-start justify-center mx-auto gap-x-[50px] gap-y-[20px]">
					...
					<div className="flex flex-col flex-nowrap justify-center content-center max-w-[450px]">
						<Label htmlFor="street">
							Street<span className="text-red_color">*</span>
						</Label>
						<Input
							id="street"
							type="text"
					...
					<div className="flex flex-col flex-nowrap justify-center content-center max-w-[450px]">
						<Label htmlFor="city">
							City<span className="text-red_color">*</span>
						</Label>
						<Input
							id="city"
							type="text"
					...
					<div className="flex flex-col flex-nowrap justify-center content-center max-w-[450px]">
						<Label htmlFor="zip">
							Zip<span className="text-red_color">*</span>
						</Label>
						<Input
							id="zip"
							type="text"
					...
					<div className="flex flex-col flex-nowrap justify-center content-center max-w-[450px]">
						<Label htmlFor="country">
							State<span className="text-red_color">*</span>
						</Label>
						<Input
							id="state"
							type="text"
					...
					<div className="flex flex-col flex-nowrap justify-center content-center max-w-[450px]">
						<Label htmlFor="country">
							Country<span className="text-red_color">*</span>
						</Label>
						<Input
							id="country"
							type="text"
				...
				{!isFirstAddress && (
					<div className="flex items-center justify-center flex-col ml-5 flex-wrap">
						...
						<Checkbox
							...
							onChange={() =>
								setNewAddress({ ...newAddress, invoice: !newAddress.invoice })
							}
				...
				<div className="sticky bottom-0 left-0 right-0 bg-white_color z-10 p-4 mx-auto w-full max-w-2xl">
					<div className="flex justify-evenly gap-[20px]">
						...
						<Button type="button" onClick={close} extraClass="bg-white_color">
							Cancel
						</Button>
					</div>
				</div>
