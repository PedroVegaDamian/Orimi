...
export const Footer = () => {
  return (
    <footer className="hidden bg-white_color py-6 text-[24px] lg:sticky fixed inset-x-0 bottom-0 shadow-block shadow-[0_0px_10px_0_rgba(0,0,0,0.15)] ">
      ...
      <div className='flex justify-center items-end gap-4 order-2'>
        ...
        >
          <img className="md:w-[31px] lg:w-[31px] w-[20px] h-[20px] mr-2" src={IconPen} alt="Heart Icon" />
          <img className="md:w-[31px] lg:w-[31px] w-[20px] h-[20px] mr-2" src={IconKeyboard} alt="Heart Icon" />
          Carolina
        </a>
        <a
          target="_blank"
        ...
        >
          <img className="md:w-[31px] lg:w-[31px] w-[20px] h-[20px] mr-2" src={IconMedal} alt="Heart Icon" />
          <img className="md:w-[31px] lg:w-[31px] w-[20px] h-[20px] mr-2" src={IconKeyboard} alt="Heart Icon" />
          Pedro
        </a>
        <a
        ...
        >
          <img className="md:w-[31px] lg:w-[31px] w-[20px] h-[20px] mr-2" src={IconBug} alt="Heart Icon" />
          Silvana
        </a>
        <a
          target="_blank"
